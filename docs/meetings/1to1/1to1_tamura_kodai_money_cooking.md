...
- **合意事項:** 田村さんから、岡山のSEメンバー（下辻氏）、SEOコンサルタント、FCコンサルタントの紹介を検討・実施する。下辻氏との第1回 1to1 **実施済み**（**2026-05-19 JST 14:00〜**・Zoom）→ [`1to1_shimotsuji_hs_neo_project.md`](1to1_shimotsuji_hs_neo_project.md)（同業・協力体制・友達申請合意）。**SEOコンサル（垣谷直人・合同会社 dock.）** 第1回 1to1 **実施済み**（**2026-06-04 JST 11:00–12:00**）→ [`1to1_kakiya_naoto_dock.md`](1to1_kakiya_naoto_dock.md)（予約管理×SEO/MEO協業・相互紹介合意）。**FCコンサル紹介は TODO**。
