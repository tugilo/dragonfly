...
- **紹介希望（2026-08-05 懇親会 → 08-06）:** **リージョンフォーラム後**の DragonFly×カーネル×サンダーボルト合同懇親会で、下辻さんが次廣へ **里見允二**さん（サトミ紙工・津山）を「ぜひ繋いでください」と希望。以前から交流会で拝見し「地元のために頑張っている里見さんといつか繋がりたい」との想い。
- **里見さん OK（2026-08-06）:** 打診に対し里見さんから接続 OK。次は下辻さんへ「早速お繋ぎする」旨を伝え、三者グループ作成。
- **次アクション:** **下辻さんへおつなぎ予告送信 → 三者グループ**（優先）。友達申請・継続情報交換。次廣は協力依頼時に**予算・タイミング**で提案準備。Religo `one_to_ones.id = 27`。
...
| **次廣** | **岡山繋がり**で **里見允二**（DragonFly／サトミ紙工）を下辻さんへつなぐ（08-05 合同懇親会で「ぜひ繋いで」） | **里見 OK（2026-08-06）** → 下辻へ予告 → 三者おつなぎ |

#### 未解決・フォローアップ

- **里見允二さんとの接続** — 里見 OK 済。下辻へ予告 → 三者グループ送信（下記文案）
...
## ■ フォロー・紹介希望（2026-08-06 記録）

- **希望者:** 下辻 宏明さん（hsネオプロジェクト／BNI カーネル）
- **つなぎ先:** [**里見允二**](1to1_satomi_masatsugu_satomishikoh.md) さん（サトミ紙工／DragonFly・岡山県津山市）
- **直接の打診場:** **2026-08-05** リージョンフォーラム後の合同懇親会（**DragonFly × カーネル × サンダーボルト**）。下辻さんも参加し、その場で次廣へ **「ぜひ繋いでください」** と希望。
- **文脈:** **岡山繋がり**（下辻＝岡山SE・カーネル、里見＝津山・DragonFly）。次廣が双方と121済みのためブリッジ可能。
- **下辻さんの想い（本人談）:** いろんな交流会で里見さんを拝見しており、**地元のために頑張っている里見さんといつか繋がりたい**と思っていた。懇親会で改めて明示。
- **進め方:** 里見さんへ打診 → **OK取得（2026-08-06）** → 下辻さんへ「早速お繋ぎする」旨 → 三者グループおつなぎ。
- **種別:** クロスチャプター（Kernel → DragonFly）。同章メンバー同士のRFではない。
- **状態:** **里見さん OK 済**。下辻さんへの予告送信後、**三者グループ（濃いティーアップ文）送信 TODO**。
- **Religo:** 下辻 `members.id=121` / `one_to_ones.id=27` · 里見 `members.id=39` / `one_to_ones.id=111`
- **懇親会の開始／終了時刻:** **TODO**（カレンダー等で確定）

### 下辻さんへのおつなぎ予告（2026-08-06・案A・推奨）

**用途:** 里見さん OK 後、三者グループ作成前に下辻さんへ一声。Messenger 等。

> 下辻さん、次廣です。
>
> 昨日の合同懇親会でお願いいただいた、DragonFly の **里見允二**さん（サトミ紙工・岡山津山）へのおつなぎですが、里見さんから OK をいただきました。
>
> これからグループで早速お繋ぎしますね。少々お待ちください！

### 下辻さんへのおつなぎ予告（案B・短文）

> 下辻さん、次廣です。懇親会でお願いいただいた里見允二さん、OKいただきましたので、これからグループで早速お繋ぎします！

### 三者グループ用（里見OK済・2026-08-06 送信用・濃いティーアップ）

※全文の正は [`1to1_satomi_masatsugu_satomishikoh.md`](1to1_satomi_masatsugu_satomishikoh.md)「三者グループ用」。こちらは同文のコピー。

**グループ名:** `【おつなぎ】里見さん⇄下辻さん`
...
- **下辻 → 里見允二（里見 OK・おつなぎ直前）:** 岡山繋がり。08-05 懇親会で希望 → 08-06 里見 OK。次廣が三者グループでブリッジ（[`1to1_satomi_masatsugu_satomishikoh.md`](1to1_satomi_masatsugu_satomishikoh.md)）
