...
- **次廣のアクション:** 今週中に本 1to1 を **リファラルとして記録**。**ジンボウさん** との 1to1 を次廣経由リファラルとして実施。夏頃システムリリース時に野口さんへ営業。美容業界で面白い人と会ったら野口さんへ紹介。
...
- **Religo 1to1 レコード:** TODO（今週中にリファラルとして記録予定）
...
- **次廣:** 今週中に野口さんとの 1to1 を **リファラルとして記録**（Religo／BNI）。
...
- **短期:** 今週中に 1to1 を **BNIリファラル記録**。ジンボウさん 1to1 を **リファラルとして実施**（野口さんへのギバー）。
