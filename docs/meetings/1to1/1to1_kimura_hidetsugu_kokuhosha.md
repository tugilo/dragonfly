...
| **スコープ** | **2画面。** ①注文PDF→項目欄で編集→Oracle ②Webで作業予定表 |
...
| **次廣** | 画面モック（**2画面:** PDF入力／作業予定表） | **方針確定・未着手** |
| **次廣** | 改訂提案（2画面が軸） | **章立て確定・本文未着手** |
| **木村さん** | 生産予定組みの紙／画面の写真 | **受領（2026-08-27 23:34 JST）**。依頼表＋週次予定表 |
...
- 予定組みの紙読み確認（原本＝Excel、左＝日付、Oracle→ODBC、差し込み、作業場所、工数）
...
- **ヒアリングで見る点:** 業務フロー、既存 VB 画面、Oracle テーブル、Excel ODBC、**生産依頼表と製本作業予定表（実物受領）**、主要顧客1社の帳票、社内利用者数、保守担当の有無。
- **提案パターン:**
...
>
> 生産依頼表と、手書きの製本作業予定表もありがとうございました。画面イメージは、板橋／ふじみ野の6列と、矢印で動かしている作業に寄せます。  
> 今週中に、PDF入力と予定組みの改訂提案をお送りします。  
...
> 依頼表と手書き予定表、ありがとうございました。画面は6列グリッドに寄せます。  
> 今週中に改訂提案と画面イメージをお送りします。  
...
**更新:** 2026-08-27 23:44 JST — モックも改訂提案も2画面が軸、と固定。章立ては提案書 §16.0。  
**更新:** 2026-08-27 23:43 JST — 作るものを2本に固定。注文PDF→項目欄で編集→Oracle。Webで作業予定表。  
**更新:** 2026-08-27 23:40 JST — 予定表の原本は Excel、左に日付、注文は Oracle を ODBC で引いている、と推定して要件化。木村さん未確認。  
**更新:** 2026-08-27 23:38 JST — 予定表の紙読みを要件化。印刷後の差し込み、縦列＝作業場所、工数を見ながら入れ替え、追加注文の手書き。木村さん未確認。  
**更新:** 2026-08-27 23:34 JST — 生産依頼表・製本作業予定表（手書き）を受領。追加要件と提案書 §16 に反映。モックは6列グリッド。  
