...
| [phases/PHASE14_RELIGO_MEMBER_MODEL_REFACTOR_PLAN.md](process/phases/PHASE14_RELIGO_MEMBER_MODEL_REFACTOR_PLAN.md) | Phase14 Religo: Member モデルリファクタ（category/role 正規化）PLAN。 |
| [phases/PHASE14_RELIGO_MEMBER_MODEL_REFACTOR_WORKLOG.md](process/phases/PHASE14_RELIGO_MEMBER_MODEL_REFACTOR_WORKLOG.md) | Phase14 Religo: Member モデルリファクタ WORKLOG。 |
| [phases/PHASE14_RELIGO_MEMBER_MODEL_REFACTOR_REPORT.md](process/phases/PHASE14_RELIGO_MEMBER_MODEL_REFACTOR_REPORT.md) | Phase14 Religo: Member モデルリファクタ REPORT。 |
| [phases/PHASE15A_SSOT_DATA_MODEL_SYNC_PLAN.md](process/phases/PHASE15A_SSOT_DATA_MODEL_SYNC_PLAN.md) | Phase15A Religo: SSOT（DATA_MODEL）現状実装同期 PLAN。 |
| [phases/PHASE15A_SSOT_DATA_MODEL_SYNC_WORKLOG.md](process/phases/PHASE15A_SSOT_DATA_MODEL_SYNC_WORKLOG.md) | Phase15A Religo: SSOT DATA_MODEL 同期 WORKLOG。 |
| [phases/PHASE15A_SSOT_DATA_MODEL_SYNC_REPORT.md](process/phases/PHASE15A_SSOT_DATA_MODEL_SYNC_REPORT.md) | Phase15A Religo: SSOT DATA_MODEL 同期 REPORT。 |
| [phases/PHASE15B_ROLE_HISTORY_LIST_PLAN.md](process/phases/PHASE15B_ROLE_HISTORY_LIST_PLAN.md) | Phase15B Religo: 役職履歴照会 API + ReactAdmin PLAN。 |
| [phases/PHASE15B_ROLE_HISTORY_LIST_WORKLOG.md](process/phases/PHASE15B_ROLE_HISTORY_LIST_WORKLOG.md) | Phase15B Religo: 役職履歴照会 WORKLOG。 |
| [phases/PHASE15B_ROLE_HISTORY_LIST_REPORT.md](process/phases/PHASE15B_ROLE_HISTORY_LIST_REPORT.md) | Phase15B Religo: 役職履歴照会 REPORT。 |
| [phases/PHASE15C_CATEGORY_DISPLAY_PLAN.md](process/phases/PHASE15C_CATEGORY_DISPLAY_PLAN.md) | Phase15C Religo: Members カテゴリ表示最適化 PLAN。 |
| [phases/PHASE15C_CATEGORY_DISPLAY_WORKLOG.md](process/phases/PHASE15C_CATEGORY_DISPLAY_WORKLOG.md) | Phase15C Religo: カテゴリ表示 WORKLOG。 |
| [phases/PHASE15C_CATEGORY_DISPLAY_REPORT.md](process/phases/PHASE15C_CATEGORY_DISPLAY_REPORT.md) | Phase15C Religo: カテゴリ表示 REPORT。 |
