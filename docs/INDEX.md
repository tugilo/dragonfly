...
|| [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md) | **次廣淳（tugilo）常設:** BO・25秒WP・60秒稿・1分クロージング・**§4／§8 DragonFly参加のきっかけ**・**§8 121**（士業・税理士向け接続フレーズ含む）・**§9 人間×AI（tugiloの考え）**・朝礼/例会・変更ログ。 |
