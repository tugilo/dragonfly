...
| ファイル | 説明 |
|----------|------|
| [academy/キースキルズ/メインプレゼン/BNI_KeySkills_MainPresentation_5min_Tsugihiro_202604.md](academy/キースキルズ/メインプレゼン/BNI_KeySkills_MainPresentation_5min_Tsugihiro_202604.md) | **KeySkills・メインプレゼン（5分）**（次廣／tugilo）。**25秒WP・BOから順に埋める**・§0冒頭＋**本文は改善事例2件**（FC・複数拠点）・PG・完成例§4・**教材PG**（[メインプレゼンテーション-PG.pdf](academy/キースキルズ/メインプレゼン/メインプレゼンテーション-PG.pdf)）。関連: [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md)。 |
