...
|| [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md) | **次廣淳（tugilo）常設:** BO・25秒WP（**§2.5 症状型**）・**§10 BNI活用とビジネス設計**（**§10.3 入口設計**・**§10.7 今週の実験サイクル**・**§10.8 1本化モデル**）・**§8 121**・**§9 人間×AI**・朝礼/例会・変更ログ。 |
