...
| [meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260826.md](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260826.md) | **木村秀継 第3回121 追加要件**。生産予定組み（DnD・提案→承認）、PostgreSQL、Docker／専用PC、助成金は9/1相談。7月提案は上書きせず §16 に追加。見積数字は据え置き。 |
...
| [proposals/木村さん用/README.md](proposals/木村さん用/README.md) | **木村秀継（国宝社 / BPS木村）共有資料**。7月受領の入口資料。追加要件は提案書 §16。画面モックは未着手。TTJUCUHD/DT、サンプル Excel、注文書 PDF、**Genspark提案スライド（16枚・2026-07-05）**。 |
