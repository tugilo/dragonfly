...
|| [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md) | **次廣淳（tugilo）常設:** BO自己紹介・25秒WP・朝礼/例会（BNI参加目的／DragonFly選定理由含む）・キーワード・変更ログ。ブラッシュアップの単一参照先。 |
