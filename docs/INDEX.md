...
| [meetings/1to1/1to1_kimura_hidetsugu_kokuhosha.md](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha.md) | **木村秀継（株式会社国宝社）**。**第1回 2026-05-08 JST 14:00〜**（終了時刻 TODO）・Zoom。創業160年の製本会社・家系図/ルーツ調査・YouTube・既存 VB+Oracle システム改善相談・クラウド移行提案・次回ヒアリング Todo を整理。 |
...
| ファイル | 説明 |
|----------|------|
| [academy/キースキルズ/メインプレゼン/BNI_KeySkills_MainPresentation_5min_Tsugihiro_202604.md](academy/キースキルズ/メインプレゼン/BNI_KeySkills_MainPresentation_5min_Tsugihiro_202604.md) | **KeySkills・メインプレゼン（5分）**（次廣／tugilo）。§4冒頭に**屋号由来**（つぎろ＝次廣×ligilo）。**25秒WP・BOから順に埋める**・§0冒頭＋**本文は改善事例2件**（FC・複数拠点）・PG・完成例§4・**教材PG**（[メインプレゼンテーション-PG.pdf](academy/キースキルズ/メインプレゼン/メインプレゼンテーション-PG.pdf)）。関連: [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md)。 |
...
| ファイル | 説明 |
|----------|------|
| [README.md](process/README.md) | process/ の必須ルール（進捗・INDEX 更新・**日付は時刻まで**・取得コマンド例）。 |
...
|| [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md) | **次廣淳（tugilo）常設:** BO自己紹介・25秒WP・2026-05-19 スタートダッシュ60秒稿・ターゲット/メリット重視の1分クロージング・朝礼/例会（BNI参加目的／DragonFly選定理由含む）・キーワード・変更ログ。ブラッシュアップの単一参照先。 |
