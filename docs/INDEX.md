...
| [ADMIN_GLOBAL_OWNER_SELECTION.md](SSOT/ADMIN_GLOBAL_OWNER_SELECTION.md) | **グローバルヘッダーでの Owner 選択**・全画面で同一 `owner_member_id` を基準にする要件。将来の認証導入時は選択 UI を削っても Owner ID スコープは維持。 |
