...
| [pdf/260707/定例会参加者リスト2026_07_07.pdf](pdf/260707/定例会参加者リスト2026_07_07.pdf) | DragonFly 定例会参加者リスト（2026-07-07・第214回）。 |
...
| [pdf/260825/定例会参加者リスト2026_08_25.pdf](pdf/260825/定例会参加者リスト2026_08_25.pdf) | DragonFly 定例会参加者リスト（2026-08-25・第219回）。 |
| [pdf/260825/religo_219_20260825_full.csv](pdf/260825/religo_219_20260825_full.csv) | 定例会参加者 CSV（第219回・full・`www/database/csv/` 同名参照可）。 |
...
| [meetings/Dragonfly_chapter_1toMany_Tsugihiro_20260807.md](meetings/Dragonfly_chapter_1toMany_Tsugihiro_20260807.md) | **DragonFly チャプター 1toMany 準備稿**（予定表記 2026-08-07）。**約10分・スライド同期台本**。実施後は議事録へ。 |
...
| [presentation/1toMany_-_次廣淳___tugilo_20260806090810.pdf](presentation/1toMany_-_次廣淳___tugilo_20260806090810.pdf) | **1toMany 本番スライド**（2026-08-06 生成・13枚）。現場のバラバラを一本に／防水・動物病院／育てているもの／チャプター内／切り出し。 |
...
| [pdf/1to many資料.pdf](pdf/1to%20many資料.pdf) | **1toMany コンセプト資料**（一人の事業を全員で深く知る／想いや背景→視点が返る／聴・問・話・60分進行）。`260807/1toMany_session_guide.pdf` と同内容。 |
| [pdf/260807/1toMany_session_guide.pdf](pdf/260807/1toMany_session_guide.pdf) | 同上（日付フォルダ側コピー）。 |
...
| [meetings/chapter/chapter_orientation_practice_20260828.md](meetings/chapter/chapter_orientation_practice_20260828.md) | **疑似オリエン体験会 2026-08-28**（金 15:00–16:00・Zoom）。**定例会回数外**。岡元進行・平岡オリエン。ロールプレイ4本（火曜ロック／お金／他チャプター／アンケートNO）。録画共有予定。校正: 東京LED→NE、エヌキャス→Nキャス、梅田→梅澤（仮説）、松本→増本（仮説）。 |
...
| [meetings/webmaster/webmaster_term11.md](meetings/webmaster/webmaster_term11.md) | **11期 WM 入口**（2026-08-29 10:00 JST）。人・URL・現状・Religo `meetings.id` 35〜37。 |
...
| [meetings/webmaster/webmaster_support_invite_20260826.md](meetings/webmaster/webmaster_support_invite_20260826.md) | **11期 WMサポートお声がけ**（2026-08-26 23:57 JST 閉じ）。梅澤・太田・軍司・竹村・米澤の5名快諾。個別快諾時刻は TODO。 |
...
| [meetings/webmaster/webmaster_term11_pc_survey_20260828.md](meetings/webmaster/webmaster_term11_pc_survey_20260828.md) | **11期 WM PC環境アンケート**（2026-08-29 09:59 JST）。公開済み。[回答](https://docs.google.com/forms/d/e/1FAIpQLSfdmk-vyV-EX9f5ysH9xKoOU1_mFmEJIW0QSX087Hrom3kvjA/viewform)／[シート](https://docs.google.com/spreadsheets/d/1IZN1u1OjXMvDVZTrnQHEYG05YqsxcejqkB-D5GHQVTg/edit)。 |
| [meetings/webmaster/webmaster_term11_meeting1_chouseisan_20260829.md](meetings/webmaster/webmaster_term11_meeting1_chouseisan_20260829.md) | **11期 WM 第1回ミーティング調整さん**（2026-08-29 09:59 JST 送信済み）。[調整さん](https://chouseisan.com/s?h=b220119717c94e9bb43606c0f29973bb)。 |
...
| [meetings/1to1/1to1_uotani_masaharu_kyokoko.md](meetings/1to1/1to1_uotani_masaharu_kyokoko.md) | **魚谷優治（株式会社今日 ここから／AI人材育成・システムコンサル／DragonFly ビジター）**。太田一誠紹介。**第1回 2026-08-27 JST 09:00–10:00 実施済み**（`#147` completed／`members.id=289`）。6ヶ月育成・士業人材不動産へ寄せ・Cursor。浅草橋来訪時に蔵前とんかつすぎ田。加入はタイミング次第。お礼文案あり・送信待ち。 |
...
| [meetings/1to1/1to1_senda_asami_kazutama.md](meetings/1to1/1to1_senda_asami_kazutama.md) | **千田麻美（やまと式かずたま術鑑定士／DragonFly ビジター）**。船津麻理子紹介・**2026-06-23 第212回 V01**。**第1回 2026-07-29 15:00–16:00**（`#132`）／**第2回 2026-08-25 14:00–15:00**（`#153`・入門鑑定結果共有）。家督5・側近8／概念数5・内面数8／チョキ。PayPay 3,000円・知人紹介・資料図解化。 |
...
| [meetings/1to1/1to1_satomi_masatsugu_satomishikoh.md](meetings/1to1/1to1_satomi_masatsugu_satomishikoh.md) | **里見允二（サトミ紙工／顧客ニーズを超えるパッケージ制作）**。**第1回 2026-07-08 JST 15:00–16:00 実施済み**（Zoom・Religo `one_to_ones.id=111`）。**2026-08-06:** 下辻おつなぎに里見 OK。三者濃いティーアップ文あり（送信TODO）。 |
...
| [meetings/1to1/1to1_goto_satomi_sachidesign.md](meetings/1to1/1to1_goto_satomi_sachidesign.md) | **後藤聡美（SachiDesign／物販特化デザイン／BNI EduTech）**。2026-07-09 静岡合同懇親会接点。**第1回 2026-08-06 JST 14:30–15:30 実施済み**（Zoom要約校正・`one_to_ones.id=136` completed／`members.id=276`）。デザイン×仕組み協業・相互RF・AI協業合意。校正: エルテック→EduTech、富士田→藤枝、マスモト→増本、2024独立→2026-05。会後お礼案A/B。 |
| [meetings/1to1/1to1_tamiya_yuko_hairmake_create.md](meetings/1to1/1to1_tamiya_yuko_hairmake_create.md) | **田宮裕子（出張ヘアメイク／BNI Create）**。DragonFly 第214回 V04・岡元紹介。**第1回 2026-08-06 JST 13:00–14:00 実施済み**（Zoom要約校正・`one_to_ones.id=135` completed／`members.id=212`）。昼間の企業案件シフト、WP言語化助言、プロフィール撮影／マッチング構想、相互アンテナ合意。会後お礼案A/B。 |
...
| [meetings/1to1/1to1_kimura_hidetsugu_kokuhosha.md](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha.md) | **木村秀継（株式会社国宝社／BNI SPREAD）**。第1回 `#22`／第2回 `#43`。**第3回 2026-08-26 JST 10:30–11:30 実施済み**（Zoom要約校正・Religo行未作成）。VB+Oracle温存。PDF入力＋**生産予定組み**。追加要件は [20260826](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260826.md) と提案書 §16。画面モックは未着手。GWS不採用・社内Web。 |
| [meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260529.md](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260529.md) | **木村秀継 第2回121 要望整理**。PDF注文書手入力削減、VB+Oracle温存、社内Web。第3回追加は [20260826](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260826.md)。 |
| [meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260826.md](meetings/1to1/1to1_kimura_hidetsugu_kokuhosha_requirements_20260826.md) | **木村秀継 第3回121 追加要件**。生産予定組み（6列グリッド・DnD・手追加・工数）。依頼表・予定表実物は 2026-08-27 受領。PostgreSQL、Docker／専用PC。7月提案は §16 に追加。 |
...
| [meetings/1to1/1to1_shimotsuji_hs_neo_project.md](meetings/1to1/1to1_shimotsuji_hs_neo_project.md) | **下辻宏明（株式会社hsネオプロジェクト・BNI カーネル）**。田村紹介・**同業**。**第1回 Zoom 2026-05-19 JST 14:00〜**（`one_to_ones.id=27`）。**2026-08-06:** 里見允二おつなぎに里見 OK → 下辻へ予告文あり（三者送信 TODO）。 |
...
| [meetings/1to1/1to1_nishihara_kaon_referral_imaishi.md](meetings/1to1/1to1_nishihara_kaon_referral_imaishi.md) | **西原 海成（AIコンサル・アプリ開発／営業マネージャー／非BNI）**。今西俊明氏紹介。**第1回 2026-07-02 JST 16:00–17:00 実施済み**（Religo `one_to_ones.id=105`、`members.id=190`）。**第2回 2026-07-16 JST 13:00開始・オンライン実施済み**（Religo `one_to_ones.id=114`・Zoom `89509218741`、終了時刻 TODO／DBは14:00仮置き）。西原氏同席で佐藤代表と初顔合わせし、キャパシティ超過時の相互外注、案件共有→概算→営業フィー加算の見積フローを確認。手数料の割合・適用条件は実案件前に書面確認する。 |
| [meetings/1to1/1to1_hatta_genji_hatta_design.md](meetings/1to1/1to1_hatta_genji_hatta_design.md) | **八田 玄治（HATTA DESIGN OFFICE／グラフィック＆WEBデザイナー／ビジター）**。今西俊明氏紹介（元上司）。**6/23 第212回 V11 初参加**。**第1回 2026-07-03 JST 13:00–14:00 実施済み**（次廣×八田・Zoom）。UI協業・静岡観光協会チラシ来年度依頼（約5万円）・AI活用議論・8/4定例会（今西MP）再参加。入会は費用面で保留。Religo id TODO。 |
...
| [meetings/1to1/1to1_morizono_yuki_4stella.md](meetings/1to1/1to1_morizono_yuki_4stella.md) | **森園友喜（4Stella合同会社／AI×事務代行／BNI DragonFly）**。**第1回 2026-07-01 JST 13:00–14:00 実施済み**・**Religo `one_to_ones.id=91`**。Zoom要約反映。協業・相互紹介合意（建設・製造×事務代行↔仕組み化）、Religo紹介、増本・平岡・清原・杏那・小中を紹介候補に整理。70名体制・5時間2万円〜・Before/After追加アドバイス・TLT後121本格化。 |
| [meetings/1to1/1to1_mochizuki_masayuki_moonlight.md](meetings/1to1/1to1_mochizuki_masayuki_moonlight.md) | **望月雅幸（合同会社 moonlight／社労士・スタートアップ企業／BNI DragonFly）**。**第1回 2026-03-06 JST 14:00–15:00**（`one_to_ones.id=6`）→ **第2回 2026-07-02 JST 15:00–16:00 実施済み**（`one_to_ones.id=93`）。働き方改革助成金×システム協業・AI活用（Claude Code/Obsidian/MCP）・WEBマスター標準化・沢田氏紹介・キントーンCSV共有・トナカ勧誘・チャプター共有を整理。 |
...
| [meetings/1to1/1to1_mihara_naoya_nomore.md](meetings/1to1/1to1_mihara_naoya_nomore.md) | **三原直也（株式会社NOMORE／Notionによる生産性向上支援・BNI インフィニティ）**。**第1回 2026-07-23 JST 14:00–15:15 実施済み**（Zoom要約校正・`one_to_ones.id=119` completed／`members.id=233`）。システム非対象→Notion紹介の連携合意、製造・士業紹介、Religo共鳴、定期1to1、清水移籍（今西さん働きかけ）を整理。 |
...
| [meetings/1to1/1to1_masumoto_shigetaka_pestblock.md](meetings/1to1/1to1_masumoto_shigetaka_pestblock.md) | **増本重孝（株式会社プロテクトラボ／害虫ブロックFC・ピタカット）**。**第1回 2026-06-12 JST 16:00–17:00**（`one_to_ones.id=76`）／**第2回 2026-07-23 JST 08:00–09:30**（`one_to_ones.id=127`）。第2回で販売代理店ページ・顧客種別・電子契約・初期3万/更新2万・OEM（ローソン・マクドナルド）・生産10月試作品・HP方針・増本バイス案を確定。 |
...
| [meetings/1to1/1to1_takemura_yuji_onode.md](meetings/1to1/1to1_takemura_yuji_onode.md) | **竹村裕司（株式会社ONODE／コンビニプリント販売・チアプリント／DragonFly メンバー）**。第1回 **2026-06-26 JST 09:00–10:00**（`#88` guest）／第2回 **2026-07-23 JST 20:00–20:30** 緊急相談（`#128` member・manual）。対象 [Cheer Print](https://www.cheer-print.com/)。**実行計画 SSOT:** [event_access_plan](proposals/takemura_cheer_print_event_access_plan.md)。外向け: [access_load_proposal](proposals/takemura_cheer_print_access_load_proposal.md)。 |
...
| [meetings/1to1/1to1_hirano_masakuni_biken_tecno.md](meetings/1to1/1to1_hirano_masakuni_biken_tecno.md) | **平野眞邦（有限会社 美研テクノ／BNI クリエーションズ）**。平岡さん紹介・**第1回 2026-07-01 JST 15:00–16:00 実施済み**（6/19 からリスケ）。防水・塗装本業と環境部（害虫ブロック・節電ガラスコート・植物触媒等）、相互紹介合意、福士 CTP2000 施工連携の話題（**次廣からの福士紹介なし・既存接点**）、Pリンク・LINE日報事例共有。Religo `one_to_ones.id=83`。 |
...
| [meetings/1to1/1to1_yokoyama_naomu_dashcamp.md](meetings/1to1/1to1_yokoyama_naomu_dashcamp.md) | **横山尚武（ダッシュキャンプ／事業のオンライン展開サポート・BNI DragonFly・スリーバイス）**。**第2回 2026-07-02 JST 10:30–11:30 実施済み**（Zoom要約校正反映）。ダッシュキャンプ一旦ステイ・小中ファシリ役割再整理・DX顧問/OJTモデル・期待値vs基準値・AI活用事例・BNI振り返り・占い鑑定・木村杏那住み分け・累積インサイト・リファーラル戦略。第1回は約3ヶ月前（日時 TODO）。`members.id=15`・`one_to_ones.id=106`。 |
| [meetings/1to1/1to1_umezawa_akihiro_sdgus.md](meetings/1to1/1to1_umezawa_akihiro_sdgus.md) | **梅澤朗広（SDGusサポーターズ／ゲームで学べる脱炭素経営・BNI DragonFly）**。**第1回 2026-07-02 JST 14:00–15:00 実施済み**（Zoom要約反映）。TGX・「知る・測る・減らす」ビジネスチーム・Religo全面協力・製造部品メーカー紹介合意・9/1 MPリリース・更新率46%課題。`members.id=28`・Religo `one_to_ones.id=92`。 |
| [meetings/1to1/1to1_kato_ryuta_steakhouse.md](meetings/1to1/1to1_kato_ryuta_steakhouse.md) | **加藤隆太（事務屋／阿久津公一税理士事務所・BNIカテゴリー ステーキハウス）**。**第1回 2026-07-03 JST 09:00–10:00 実施済み**（Zoom詳細要約反映）。事務屋整頓→引き継ぎモデル・FC仕入れ（タミー食品/元気豚/魔王焼酎）・口コミSNS 2,000アカウント・BNI8年部活哲学・別名ビジター・富士宮質屋継承・DragonFly継続検討・次廣へCポイント/朝121助言。Religo `one_to_ones.id=104`。 |
...
| [meetings/1to1/1to1_tabuchi_kyohei_tabuchi_stone.md](meetings/1to1/1to1_tabuchi_kyohei_tabuchi_stone.md) | **田渕恭平（田渕石材株式会社／株式会社TABUCHI・BNI DragonFly）**。**第1回 2026-05-14 JST 17:00–18:00 実施済み**・**Religo `one_to_ones.id=82`**。**第2回は 2026-07-18 JST 10:00開始予定**（Religo `one_to_ones.id=118` planned、終了時刻・実施方法 TODO）。事前回答：ChatGPT・PLAUD・Google各種・LINE・Messenger分散と横断検索、ドライブ（ローカル／共有／クラウド未確定）整理、Claude Code／Cursor期待。SNSには絞らない。庵治石・紹介方針も整理。 |
...
| [proposals/takemura_scaffold_rental_aws_hearing_estimate.md](proposals/takemura_scaffold_rental_aws_hearing_estimate.md) | **竹村裕司・足場レンタルAWS（新規）** ヒアリング＋概算（2026-08-25）。構築38万／AWS月3〜6万／保守は稼働維持のみ月1〜2万（システム対応なし）。 |
...
| [proposals/takemura_asobisystem_wp_load_test_proposal.md](proposals/takemura_asobisystem_wp_load_test_proposal.md) | **Cheer Print 負荷対策・技術別紙**（詳細・社内用）。冒頭1分まとめ／章別読者ラベル付き。実行計画は [event_access_plan](proposals/takemura_cheer_print_event_access_plan.md)。 |
| [proposals/takemura_cheer_print_load_test_genspark_slide_prompt.md](proposals/takemura_cheer_print_load_test_genspark_slide_prompt.md) | **Cheer Print 外向け提案の Gensparkスライドプロンプト**（12枚前後）。段階見積・役割分担中心。元: [提出用ご提案](proposals/takemura_cheer_print_access_load_proposal.md)。 |
| [proposals/木村さん用/README.md](proposals/木村さん用/README.md) | **木村秀継（国宝社 / BPS木村）共有資料**。7月入口＋**2026-08-27 予定表・依頼表**。追加要件は提案書 §16。画面モックは未着手。 |
| [proposals/木村さん用/生産依頼表_画面.jpg](proposals/木村さん用/生産依頼表_画面.jpg) | **生産依頼表**（1案件）。2026-08-27 受領。業務データ・公開禁止。 |
| [proposals/木村さん用/製本作業予定表_20260907-0911_手書き.jpg](proposals/木村さん用/製本作業予定表_20260907-0911_手書き.jpg) | **製本作業予定表**（週次印刷＋手書き）。対象 2026-09-07〜11。2026-08-27 受領。業務データ・公開禁止。 |
| [proposals/木村さん用/PDF注文書入力支援システム_ご提案_20260705122750.pdf](proposals/木村さん用/PDF注文書入力支援システム_ご提案_20260705122750.pdf) | **木村秀継（国宝社）向け PDF注文書入力支援 提案スライド（Genspark生成・16枚）**。121合意（社内Web・GWS不採用）、ROI人件費試算、概算パッケージ A〜C。2026-07-05 12:27 出力。 |
| [proposals/kimura_kokuhosha_pdf_order_input_proposal.md](proposals/kimura_kokuhosha_pdf_order_input_proposal.md) | **木村秀継（国宝社）向け PDF注文書入力支援 提案書。** §1–15 は7月入口。**§16** に第3回追加（予定組み・PostgreSQL・Docker／専用PC・助成金計画）。画面モックは未作成。 |
| [proposals/kimura_kokuhosha_pdf_order_input_genspark_slide_prompt.md](proposals/kimura_kokuhosha_pdf_order_input_genspark_slide_prompt.md) | **Genspark用スライド生成プロンプト**。国宝社 PDF入力支援提案書を、木村さん向け14〜16枚の経営者・現場向けスライドに変換。121合意（社内Web・GWS不採用）・ROI試算を反映。出力: [提案スライド PDF](proposals/木村さん用/PDF注文書入力支援システム_ご提案_20260705122750.pdf)。 |
| [proposals/kimura_kokuhosha_pdf_order_input_estimate.md](proposals/kimura_kokuhosha_pdf_order_input_estimate.md) | **木村秀継（国宝社）向け PDF注文書入力支援 概算見積（案・税別・7月入口のみ）**。A〜C（50万〜230万）＋**サーバー構築 30〜38万**。B+箱で約210〜220万。予定組みは未算入。改訂版で組み直す。 |
...
| [proposals/printing_business_improvement_estimate.md](proposals/printing_business_improvement_estimate.md) | **印刷業向け 業務改善システム 概算見積（案・税別）**。核スコープ、120万規模の内訳、補助金・進め方。2026-07-16、芳賀さんの仲介で次廣・助成金担当の望月さん・クライアントを含む4者グループが作成され、受注可能性ありの初期調整段階へ進展。overview / PDF スライドと対。 |
...
| [CONNECTION_PREPARATION_REQUIREMENTS.md](SSOT/CONNECTION_PREPARATION_REQUIREMENTS.md) | **SPEC-022** — つなぐ準備（候補行ごと「紹介文を作成」・A/B 手動指定・了承依頼/グループ投稿コピペ）。Phase 274 実装済み。 |
| [FIT_AND_GAP_REFERRAL_SUGGESTION_SELF_CONNECTOR.md](SSOT/FIT_AND_GAP_REFERRAL_SUGGESTION_SELF_CONNECTOR.md) | **リファーラル提案の自己つなぎ手誤提案 Fit&Gap**。`via_connector` で requester 本人が connector になる Gap（海沼功 121 run #19）を、COMMON §0.8 / SPEC-015 / SPEC-016 / SPEC-022 と現行実装で比較。Phase 276 PLAN の根拠。 |
...
| [phases/PHASE_270_member_email_drawer_edit_PLAN.md](process/phases/PHASE_270_member_email_drawer_edit_PLAN.md) | Phase 270: メンバー詳細ドロワーからの email インライン編集（Fit&Gap G1 解消）PLAN。 |
| [phases/PHASE_270_member_email_drawer_edit_WORKLOG.md](process/phases/PHASE_270_member_email_drawer_edit_WORKLOG.md) | Phase 270: 同 WORKLOG。 |
| [phases/PHASE_270_member_email_drawer_edit_REPORT.md](process/phases/PHASE_270_member_email_drawer_edit_REPORT.md) | Phase 270: 同 REPORT。 |
| [phases/PHASE_271_member_email_drawer_permission_fix_PLAN.md](process/phases/PHASE_271_member_email_drawer_permission_fix_PLAN.md) | Phase 271: Members ドロワー email 編集の admin 判定安定化 PLAN。 |
| [phases/PHASE_271_member_email_drawer_permission_fix_WORKLOG.md](process/phases/PHASE_271_member_email_drawer_permission_fix_WORKLOG.md) | Phase 271: 同 WORKLOG。 |
| [phases/PHASE_271_member_email_drawer_permission_fix_REPORT.md](process/phases/PHASE_271_member_email_drawer_permission_fix_REPORT.md) | Phase 271: 同 REPORT。 |
| [phases/PHASE_272_tokyo_ne_region_chapter_1to1_PLAN.md](process/phases/PHASE_272_tokyo_ne_region_chapter_1to1_PLAN.md) | Phase 272: 東京 NE リージョン・チャプターマスタシードと 1to1 相手選択 PLAN（SPEC-021）。 |
| [phases/PHASE_272_tokyo_ne_region_chapter_1to1_WORKLOG.md](process/phases/PHASE_272_tokyo_ne_region_chapter_1to1_WORKLOG.md) | Phase 272: 同 WORKLOG。 |
| [phases/PHASE_272_tokyo_ne_region_chapter_1to1_REPORT.md](process/phases/PHASE_272_tokyo_ne_region_chapter_1to1_REPORT.md) | Phase 272: 同 REPORT。 |
| [phases/PHASE_273_weekly_presentation_plain_PLAN.md](process/phases/PHASE_273_weekly_presentation_plain_PLAN.md) | Phase 273: ウィークリープレゼン リテラシ配慮版へ差し替え PLAN（症状型・member 37 weekly_presentation_body）。 |
| [phases/PHASE_273_weekly_presentation_plain_WORKLOG.md](process/phases/PHASE_273_weekly_presentation_plain_WORKLOG.md) | Phase 273: 同 WORKLOG。 |
| [phases/PHASE_273_weekly_presentation_plain_REPORT.md](process/phases/PHASE_273_weekly_presentation_plain_REPORT.md) | Phase 273: 同 REPORT。 |
...
| [phases/PHASE_274_referral_connect_copy_PLAN.md](process/phases/PHASE_274_referral_connect_copy_PLAN.md) | Phase 274: リファーラル提案 — 紹介文作成（つなぐ準備・コピペ）PLAN。 |
| [phases/PHASE_274_referral_connect_copy_WORKLOG.md](process/phases/PHASE_274_referral_connect_copy_WORKLOG.md) | Phase 274: 同 WORKLOG。 |
| [phases/PHASE_274_referral_connect_copy_REPORT.md](process/phases/PHASE_274_referral_connect_copy_REPORT.md) | Phase 274: 同 REPORT。 |
| [phases/PHASE_276_referral_suggestion_self_connector_guard_PLAN.md](process/phases/PHASE_276_referral_suggestion_self_connector_guard_PLAN.md) | Phase 276: リファーラル提案 — 自己つなぎ手誤提案ガード PLAN。 |
| [phases/PHASE_276_referral_suggestion_self_connector_guard_WORKLOG.md](process/phases/PHASE_276_referral_suggestion_self_connector_guard_WORKLOG.md) | Phase 276: 同 WORKLOG。 |
| [phases/PHASE_276_referral_suggestion_self_connector_guard_REPORT.md](process/phases/PHASE_276_referral_suggestion_self_connector_guard_REPORT.md) | Phase 276: 同 REPORT。 |
| [phases/PHASE_277_shizuoka_joint_social_roster_requirements_PLAN.md](process/phases/PHASE_277_shizuoka_joint_social_roster_requirements_PLAN.md) | Phase 277: 静岡合同懇親会 参加者名簿要件整理 PLAN。 |
| [phases/PHASE_277_shizuoka_joint_social_roster_requirements_WORKLOG.md](process/phases/PHASE_277_shizuoka_joint_social_roster_requirements_WORKLOG.md) | Phase 277: 同 WORKLOG。 |
| [phases/PHASE_277_shizuoka_joint_social_roster_requirements_REPORT.md](process/phases/PHASE_277_shizuoka_joint_social_roster_requirements_REPORT.md) | Phase 277: 同 REPORT。 |
| [phases/PHASE_278_shizuoka_joint_social_roster_outputs_PLAN.md](process/phases/PHASE_278_shizuoka_joint_social_roster_outputs_PLAN.md) | Phase 278: 静岡合同懇親会 参加者名簿作成 PLAN。 |
| [phases/PHASE_278_shizuoka_joint_social_roster_outputs_WORKLOG.md](process/phases/PHASE_278_shizuoka_joint_social_roster_outputs_WORKLOG.md) | Phase 278: 同 WORKLOG。 |
| [phases/PHASE_278_shizuoka_joint_social_roster_outputs_REPORT.md](process/phases/PHASE_278_shizuoka_joint_social_roster_outputs_REPORT.md) | Phase 278: 同 REPORT。 |
| [phases/PHASE_279_referral_suggestion_force_regenerate_PLAN.md](process/phases/PHASE_279_referral_suggestion_force_regenerate_PLAN.md) | Phase 279: リファーラル提案 — 再生成 force PLAN。 |
| [phases/PHASE_279_referral_suggestion_force_regenerate_WORKLOG.md](process/phases/PHASE_279_referral_suggestion_force_regenerate_WORKLOG.md) | Phase 279: 同 WORKLOG。 |
| [phases/PHASE_279_referral_suggestion_force_regenerate_REPORT.md](process/phases/PHASE_279_referral_suggestion_force_regenerate_REPORT.md) | Phase 279: 同 REPORT。 |
| [phases/PHASE_280_morita_yoshiaki_121_prep_PLAN.md](process/phases/PHASE_280_morita_yoshiaki_121_prep_PLAN.md) | Phase 280: 森田悦章 初回121事前準備 PLAN。 |
| [phases/PHASE_280_morita_yoshiaki_121_prep_WORKLOG.md](process/phases/PHASE_280_morita_yoshiaki_121_prep_WORKLOG.md) | Phase 280: 同 WORKLOG。 |
| [phases/PHASE_280_morita_yoshiaki_121_prep_REPORT.md](process/phases/PHASE_280_morita_yoshiaki_121_prep_REPORT.md) | Phase 280: 同 REPORT。 |
| [phases/PHASE_281_makita_sanako_121_prep_PLAN.md](process/phases/PHASE_281_makita_sanako_121_prep_PLAN.md) | Phase 281: 牧田佐奈子 初回121事前準備 PLAN。 |
| [phases/PHASE_281_makita_sanako_121_prep_WORKLOG.md](process/phases/PHASE_281_makita_sanako_121_prep_WORKLOG.md) | Phase 281: 同 WORKLOG。 |
| [phases/PHASE_281_makita_sanako_121_prep_REPORT.md](process/phases/PHASE_281_makita_sanako_121_prep_REPORT.md) | Phase 281: 同 REPORT。 |
| [phases/PHASE_282_imamura_chie_121_prep_PLAN.md](process/phases/PHASE_282_imamura_chie_121_prep_PLAN.md) | Phase 282: 今村千絵 初回121事前準備 PLAN。 |
| [phases/PHASE_282_imamura_chie_121_prep_WORKLOG.md](process/phases/PHASE_282_imamura_chie_121_prep_WORKLOG.md) | Phase 282: 同 WORKLOG。 |
| [phases/PHASE_282_imamura_chie_121_prep_REPORT.md](process/phases/PHASE_282_imamura_chie_121_prep_REPORT.md) | Phase 282: 同 REPORT。 |
| [phases/PHASE_283_makita_sanako_121_minutes_PLAN.md](process/phases/PHASE_283_makita_sanako_121_minutes_PLAN.md) | Phase 283: 牧田佐奈子 第1回121 Zoom要約反映 PLAN。 |
| [phases/PHASE_283_makita_sanako_121_minutes_WORKLOG.md](process/phases/PHASE_283_makita_sanako_121_minutes_WORKLOG.md) | Phase 283: 同 WORKLOG。 |
| [phases/PHASE_283_makita_sanako_121_minutes_REPORT.md](process/phases/PHASE_283_makita_sanako_121_minutes_REPORT.md) | Phase 283: 同 REPORT。 |
| [phases/PHASE_284_tabuchi_kyohei_121_prep_PLAN.md](process/phases/PHASE_284_tabuchi_kyohei_121_prep_PLAN.md) | Phase 284: 田渕恭平 第2回121事前準備 PLAN。 |
| [phases/PHASE_284_tabuchi_kyohei_121_prep_WORKLOG.md](process/phases/PHASE_284_tabuchi_kyohei_121_prep_WORKLOG.md) | Phase 284: 同 WORKLOG。 |
| [phases/PHASE_284_tabuchi_kyohei_121_prep_REPORT.md](process/phases/PHASE_284_tabuchi_kyohei_121_prep_REPORT.md) | Phase 284: 同 REPORT。 |
| [phases/PHASE_285_nishihara_kaisei_121_second_prep_PLAN.md](process/phases/PHASE_285_nishihara_kaisei_121_second_prep_PLAN.md) | Phase 285: 西原海成 第2回121予定・Zoom要約反映 PLAN。 |
| [phases/PHASE_285_nishihara_kaisei_121_second_prep_WORKLOG.md](process/phases/PHASE_285_nishihara_kaisei_121_second_prep_WORKLOG.md) | Phase 285: 同 WORKLOG。 |
| [phases/PHASE_285_nishihara_kaisei_121_second_prep_REPORT.md](process/phases/PHASE_285_nishihara_kaisei_121_second_prep_REPORT.md) | Phase 285: 同 REPORT。 |
| [phases/PHASE_286_sawada_kosuke_121_prep_PLAN.md](process/phases/PHASE_286_sawada_kosuke_121_prep_PLAN.md) | Phase 286: 澤田行助 初回121事前準備 PLAN。 |
| [phases/PHASE_286_sawada_kosuke_121_prep_WORKLOG.md](process/phases/PHASE_286_sawada_kosuke_121_prep_WORKLOG.md) | Phase 286: 同 WORKLOG。 |
| [phases/PHASE_286_sawada_kosuke_121_prep_REPORT.md](process/phases/PHASE_286_sawada_kosuke_121_prep_REPORT.md) | Phase 286: 同 REPORT。 |
| [phases/PHASE_287_sawada_kosuke_121_minutes_PLAN.md](process/phases/PHASE_287_sawada_kosuke_121_minutes_PLAN.md) | Phase 287: 澤田行助 第1回121 Zoom要約反映 PLAN。 |
| [phases/PHASE_287_sawada_kosuke_121_minutes_WORKLOG.md](process/phases/PHASE_287_sawada_kosuke_121_minutes_WORKLOG.md) | Phase 287: 同 WORKLOG。 |
| [phases/PHASE_287_sawada_kosuke_121_minutes_REPORT.md](process/phases/PHASE_287_sawada_kosuke_121_minutes_REPORT.md) | Phase 287: 同 REPORT。 |
| [phases/PHASE_288_koshiga_toshie_121_prep_PLAN.md](process/phases/PHASE_288_koshiga_toshie_121_prep_PLAN.md) | Phase 288: 越賀淑恵 初回121事前準備 PLAN。 |
| [phases/PHASE_288_koshiga_toshie_121_prep_WORKLOG.md](process/phases/PHASE_288_koshiga_toshie_121_prep_WORKLOG.md) | Phase 288: 同 WORKLOG。 |
| [phases/PHASE_288_koshiga_toshie_121_prep_REPORT.md](process/phases/PHASE_288_koshiga_toshie_121_prep_REPORT.md) | Phase 288: 同 REPORT。 |
...
| [phases/PHASE_299_chapter_1tomany_minutes_import_PLAN.md](process/phases/PHASE_299_chapter_1tomany_minutes_import_PLAN.md) | Phase 299: 1toMany 議事録 DB 取り込み（chapter_1tomany）PLAN。 |
| [phases/PHASE_299_chapter_1tomany_minutes_import_WORKLOG.md](process/phases/PHASE_299_chapter_1tomany_minutes_import_WORKLOG.md) | Phase 299: 同 WORKLOG。 |
| [phases/PHASE_299_chapter_1tomany_minutes_import_REPORT.md](process/phases/PHASE_299_chapter_1tomany_minutes_import_REPORT.md) | Phase 299: 同 REPORT（ローカル＋prod push）。 |
...
| [bni_shizuoka_joint_social_roster_requirements.md](requirements/bni_shizuoka_joint_social_roster_requirements.md) | **BNI 静岡合同懇親会 参加者名簿 要件定義**。Google フォーム回答から A4 印刷用名簿とスマホ閲覧用名簿を作るための入力列、チャプター別参加者数順・参加者名順、`その他` チャプター扱い、個人情報・公開範囲、確認事項を整理。 |
