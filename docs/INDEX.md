...
| [SONAE_REQUIREMENTS.md](SSOT/SONAE_REQUIREMENTS.md) | **SPEC-017** — SONAE 要件定義。Religo 拡張モジュールとして始めつつ、小規模コミュニティ・家族・仲間・団体でも単体利用できる安否確認/緊急連絡サービス。DragonFly PoC、独自LINE公式アカウント接続、LINE通数費用、将来課金モデル、気象庁連携、訓練、回答集計、ER設計案を整理。 |
