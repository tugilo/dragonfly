...
| [FIT_AND_GAP_MARKDOWN_VIEWER.md](SSOT/FIT_AND_GAP_MARKDOWN_VIEWER.md) | **Markdown ビューア**（議事録・1to1 notes）の Fit/Gap。`MarkdownView` + `remark-gfm`（Phase 181）。メモタブ pre-wrap 残存は P2 候補。 |
