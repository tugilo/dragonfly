...
| ファイル | 説明 |
|----------|------|
| [academy/キースキルズ/メインプレゼン/BNI_KeySkills_MainPresentation_5min_Tsugihiro_202604.md](academy/キースキルズ/メインプレゼン/BNI_KeySkills_MainPresentation_5min_Tsugihiro_202604.md) | **KeySkills・メインプレゼン（5分）**（次廣／tugilo）。**§4.1 リハ版（2026-06-08）** — 3部構成・**一人称「私」**・運命的な出会い／ニセ理系／困りごとの言語化を軸に5分へ圧縮。今日のアジェンダ、事例改善効果（確認・転記半分以下／数時間分の確認作業削減）、**§4.1.1 Gensark資料化プロンプト**（文字少なめ・図多め）を追加。藤井さん **「あったらいいなを形にしてくれる」**。§4確定稿・PG・**DragonFly 本番 2026-06-23**・リハ 6/8・6/15（各20:00 JST）。**関連:** [BNI_Tsugihiro_Atsushi_Intro_Living_Document.md](strategy/networking/BNI_Tsugihiro_Atsushi_Intro_Living_Document.md)。 |
