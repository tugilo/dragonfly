...
| [meetings/1to1/1to1_nishihara_kaon_referral_imaishi.md](meetings/1to1/1to1_nishihara_kaon_referral_imaishi.md) | **西原 海成（AIコンサル・アプリ開発／営業マネージャー／非BNI）**。今西俊明氏紹介。**第1回 2026-07-02 JST 16:00–17:00 実施済み**。外注・案件相互紹介合意、代表佐藤氏紹介予定、製造業AI案件相談、**7/28 BOD・8/4 定例会（今西MP）ビジター参加予定**。Religo id TODO。 |
...
| [meetings/1to1/1to1_kato_ryuta_steakhouse.md](meetings/1to1/1to1_kato_ryuta_steakhouse.md) | **加藤隆太（ステーキハウス／事務屋・飲食FC・広報SNS・BNI DragonFly）**。**第1回 2026-07-03 JST 09:00–10:00 実施済み**（Zoom要約反映）。多柱事業・BNI「部活」・121 2,500件+・富士宮移住・8月質屋継承・DragonFly継続検討・次廣へBNIアドバイス。Religo `one_to_ones.id=104`・`members.id=29`（39番）。 |
...
| [CONNECTION_PREPARATION_REQUIREMENTS.md](SSOT/CONNECTION_PREPARATION_REQUIREMENTS.md) | **SPEC-022** — つなぐ準備（候補行ごと「紹介文を作成」・A/B 手動指定・了承依頼/グループ投稿コピペ）。Phase 274 実装予定。 |
