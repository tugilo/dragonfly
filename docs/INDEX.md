...
| [meetings/1to1/1to1_makita_sanako_holon.md](meetings/1to1/1to1_makita_sanako_holon.md) | **牧田佐奈子（有限会社 HOLON／ダイアナ浜松／BNI ENISHI）**。2026-07-09 静岡合同懇親会で接点。**第1回 2026-07-15 JST 13:00–14:00 予定**。略歴・G.A.I.N.S.・Canvaメインプレゼンと次廣メインプレゼンを軸に、双方のプロフィール・事業背景・変化事例・紹介場面を深掘りする60分読み上げ原稿。ローカル Religo `members.id=232` / `one_to_ones.id=117`（manual・planned、原稿 notes 反映済み）。 |
...
| [meetings/1to1/1to1_nishihara_kaon_referral_imaishi.md](meetings/1to1/1to1_nishihara_kaon_referral_imaishi.md) | **西原 海成（AIコンサル・アプリ開発／営業マネージャー／非BNI）**。今西俊明氏紹介。**第1回 2026-07-02 JST 16:00–17:00 実施済み**（Zoom要約反映済み）。外注・案件相互紹介合意、代表佐藤氏紹介予定、製造業AI案件相談、**7/28 BOD・8/4 定例会（今西MP）ビジター参加予定**。**Religo `one_to_ones.id=105`**（`members.id=190`）。 |
