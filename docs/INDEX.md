...
| [meetings/1to1/1to1_iida_kaori_libero.md](meetings/1to1/1to1_iida_kaori_libero.md) | **飯田香（Libero／グラントイーワンズ代理店／BNI DragonFly）**。**第1回 2026-06-17 JST 13:00〜実施済み**（終了時刻・Religo id TODO）。Zoom要約反映。次廣事業紹介、DragonFly向け **BCPシステム（安否確認・災害通知）** 開発相談、買い切り30万円前後の検討、精密機器・医療機器部品製造業社長への紹介候補を整理。今回は香さんの事業深掘りが不足したため、次回は **香さんタイム** として Libero・下着リテラシー・飲む水を含む生活習慣・理想顧客を伺う。 |
...
| [proposals/sonae_bcp_proposal_iida_kaori.md](proposals/sonae_bcp_proposal_iida_kaori.md) | **SONAE 飯田香さん向け提案書**。DragonFly BCP担当・役員向けに、BCP担当の人力依存、半期交代による属人化、SONAEを「人を支える運営の土台」とする思想、DragonFly共創トライアル、気象庁連携、LINE通知、訓練、回答集計、チャプターごとの独立性を整理。根拠: [`SSOT/SONAE_REQUIREMENTS.md`](SSOT/SONAE_REQUIREMENTS.md)。 |
| [proposals/sonae_bcp_proposal_iida_kaori_genspark_slide_prompt.md](proposals/sonae_bcp_proposal_iida_kaori_genspark_slide_prompt.md) | **SONAE 飯田香さん向け Gensparkスライド生成プロンプト**。最新提案書をもとに、属人化から仕組み化、人に頼る運営から人を支える運営への転換、共創トライアルを伝えるPowerPoint向けスライド構成・デザイン・禁止事項を整理。 |
| [proposals/sonae_proposal3.pdf](proposals/sonae_proposal3.pdf) | **SONAE 最新PDF提案書（v3）**。飯田香さん・DragonFly BCP担当向けの16枚スライド版。人力依存から人を支える運営への転換、LINE回答、気象庁情報による自動発報、チャプターごとの独立性を視覚化。 |
...
| [SONAE_REQUIREMENTS.md](SSOT/SONAE_REQUIREMENTS.md) | **SPEC-017** — SONAE 要件定義。Religo 拡張モジュールとして始めつつ、小規模コミュニティ・家族・仲間・団体でも単体利用できる安否確認/緊急連絡サービス。DragonFly共創トライアル、独自LINE公式アカウント接続、LINE通数費用、将来課金モデル、気象庁連携、訓練、回答集計、ER設計案を整理。 |
