...
| [meetings/1to1/1to1_iida_chiho_sui.md](meetings/1to1/1to1_iida_chiho_sui.md) | **飯田千帆（彗 sui／経営者向け開運占い師／BNI DragonFly）**。**第1回 2026-06-12 JST 09:00-10:00 実施済み**・**Religo `one_to_ones.id=69`**。Zoom要約反映。視える・聴こえる霊視鑑定、1時間22,000円の総合鑑定、経営者顧問5社・鑑定1000件超・毎朝ライブ3年。次廣は **2026-06-22 10:00** にメインプレ前日鑑定を受ける予定。鑑定質問リスト・事前送付文案（メインプレは内容変更ではなく当日の状態整理、BNIカテゴリー・仕事・家族・守護霊等）作成済み。OCC・WEBマスターサポート・エデュケーションサポート、SNS/ラジオ/登壇、AI議事録化可能性、飯田香との同姓区別を整理。 |
