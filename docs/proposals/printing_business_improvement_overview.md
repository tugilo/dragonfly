...
**進め方のイメージ:** ブラウザで使う**新しい業務システムを、前提から用意する（いわゆるゼロからの構築に近い形）**想定です。いまの表計算ファイルの中身を増やしていくだけ、ではありません。一方で、**いままでの運用や明細・帳票のルールは、設計へ引き継ぐ**ので、仕事の内容を頭からすべてやり直す、という話でもありません。
 ...
 **改訂:** 初版 2026-05-12 09:25 JST。**2026-05-21:** Web は新規一から構築に近く、業務ルールは引き継ぐ旨を追記。ヒアリングや補助金条件に応じて、本文の数字・スコープは更新してください。
