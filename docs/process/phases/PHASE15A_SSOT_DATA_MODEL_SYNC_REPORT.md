...
| 項目 | 内容 |
|------|------|
| **merge commit id** | `006538eb6eac25cdc4135ae39e827c1e1fc29e2f` |
| **merge 元ブランチ名** | `feature/phase15a-ssot-data-model-sync` |
| **変更ファイル一覧** | docs/SSOT/DATA_MODEL.md, docs/INDEX.md, docs/process/phases/PHASE15A_SSOT_DATA_MODEL_SYNC_*.md（PLAN/WORKLOG/REPORT） |
