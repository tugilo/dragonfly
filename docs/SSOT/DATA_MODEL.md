...
| **ユニーク制約** | なし |
| **主要カラム** | id, name, name_kana (nullable), **category_id (nullable)**, type, display_no (nullable), **ncast_profile_url (nullable, string 2048)** — Nキャスの自己紹介ページ URL, introducer_member_id, attendant_member_id, timestamps |
